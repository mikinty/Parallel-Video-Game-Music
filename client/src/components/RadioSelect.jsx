    ...
    return (
      ...
      <form>
        <fieldset className="form__options">
          <legend className="form__question">What is your ideal match?</legend>
          ...
          <input 
              ...
              id="match_2" 
              value="Journey" 
              checked={this.state.selected == 'Journey'}
              onChange={this.handleChange.bind(this)} /> 
          ...
          <input 
              ...
              id="match_3" 
              value="Melancholy" 
              checked={this.state.selected == 'Melancholy'}
              onChange={this.handleChange.bind(this)} /> 
          ...
          <input 
              ...
              id="match_4" 
              value="Tension" 
              checked={this.state.selected == 'Tension'}
              onChange={this.handleChange.bind(this)} /> 
