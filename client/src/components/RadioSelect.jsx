...
const journey = require('./images/horse.png');
const battle = require('./images/sword.jpg');
        ...
        <fieldset className="form__options">
          ...
          <input 
            ...
            <label htmlFor="match_2">
              <img src={journey} className='buttonImage'></img>
              Journey
            </label> 
          </p>
          ...
          <input 
            ...
            <label htmlFor="match_3">
              <img src={umbrella} className='buttonImage'></img>
              Sorrow
            </label> 
          </p>
          ...
          <input 
            ...
            <label htmlFor="match_4">
              <img src={battle} className='buttonImage'></img>
              Battle
            </label> 
            </p>
        </fieldset>
